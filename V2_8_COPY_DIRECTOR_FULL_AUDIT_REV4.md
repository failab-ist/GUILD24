...
# APPENDIX A — EXPANDED DIALOGUE COPY PACK

이 Appendix는 §28의 Target 수량을 실제 Director Copy로 채운다.
WORK가 문장을 임의 생성하지 않는다.
...
“다친 데가 아직 신경 쓰여요.”
“몸이 완전히 풀리진 않았네요.”
“오늘은 평소처럼 못 움직일 것 같아요.”
“이 정도면 출발은 할 수 있습니다.”
“상처가 생각보다 오래 가네요.”
```

## A-4. ARRIVAL — REGULAR 12
...
특정 상품 선호 mechanic이 없기 때문.

## A-5. ARRIVAL — HELPED 8
...
“지난번에 산 거, 잘 썼습니다.”
“저번에 챙긴 거 덕 좀 봤어요.”
“지난 원정에서 준비한 게 제 몫을 했습니다.”
“그때 준비해 간 게 마지막에 도움이 됐어요.”
“지난번 선택은 잘한 것 같아요.”
```

### Callback Truth Fix

현재 `hasCallback`은 `last.events.length`만 보면 true라
Trait-only event까지 “지난 보급이 도움 됐다”로 말할 수 있다.

Callback은:
- sold Item의 proven event
- 실제 Item prevention / rescue / aftercare
- Item+Trait interaction처럼 Shop Item이 실제로 관여한 event

에만 사용한다.

Trait-only `injury-guard` 등은 Helped callback 근거로 쓰지 않는다.

ACTION: **P0 COPY TRIGGER FIX**

---

# APPENDIX B — TRAIT ARRIVAL POOLS
...
“아픈 가격이네요.”
“오늘은 제가 급하니까요.”
“이 정도면 서비스 하나 있어야 하는 거 아닌가요?”
“알겠습니다. 하나 주세요.”
```

---

# APPENDIX D — SALE REFUSE POOLS
...
# APPENDIX E — NIGHT LIVING POOLS

Night quote는 §13-3의 Outcome-first priority를 따른다.
...
“그걸 챙긴 게 신의 한 수였습니다.”
“살아서 여기 서 있는 이유가 있네요.”
“마지막에 그게 아니었으면 끝이었습니다.”
“오늘 준비한 것 중 하나가 목숨값을 했네요.”
```

## E-7. RESCUED RETURN — 8
...
“끝까지 갔다간 정말 위험했습니다.”
“오늘은 돌아온 것만으로 됐습니다.”
“마지막 순간에 빠져나올 수 있었습니다.”
“이번엔 무사히 나온 걸로 만족할게요.”
```

## E-8. SUCCESS + GROWTH — 10
...
“조금씩 요령이 생기네요.”
“이번 원정에서 얻은 게 있었습니다.”
“다음엔 더 자연스럽게 할 수 있겠어요.”
```

---

# APPENDIX F — DEATH NARRATION
