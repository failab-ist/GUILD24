...
- v2.9.2 봇 하네스(User 2026-09-26): `reader` 정책과 User 런 보정 도구 추가(`reports/v292-bot-harness.md`). 이를 근거로 다음 밸런스
  후보(성공·대성공 EXP 컷, 마왕 파워, 발주가·운영비)를 비교할 예정. User 결정 대기. 아이템 성능 너프는 권고에서 제외했다.
