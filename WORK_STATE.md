...
- v2.9.7 추가 (User 2026-09-26, 버전 유지): 마감 영수증을 현금흐름으로 교체 — 오늘 시작 · 들어오고 나간 돈 · 오늘 끝(±변화) · 창고 재고/폐기 개수 · 내일 운영비 예상. 머지는 User 컨펌 대기.
...
**머지 규칙 (User 2026-09-26): PR 머지는 User가 명시적으로 컨펌했을 때만 한다. 의견이 필요한 건 결정 항목과 의견을 먼저 정리해서 묻는다.**
