// v2.9.0 Re-measure worker: the v2.8 worker plus the SIM-Q72 Fatigue fields (departure bands, Food/Drink pick by band, Supply use split). Loads ONE dist/ tree (old baseline or current) and runs the
