...
**승인 — v2.9.1 소스 반영 대기** (소스에 들어가는 커밋에서 이 표기를 `**현재**`로 바꾼다)
...
(User 2026-09-25, v2.9.1; 소스에 들어가는 커밋에서 아래 두 표기를 `**현재 Flavor**` / `**현재 Function**`으로 바꾼다)

**승인 Flavor — v2.9.1 소스 반영 대기**
> 길드가 광장에 위령제 제단을 세웠다. 오늘은 모험가들도 말수가 적다.

**승인 Function — v2.9.1 소스 반영 대기**
> 남은 영업 동안 사망 한도 +1
