...
**현재 — 전체 문장** (User 2026-09-24 revision, v2.9.0: {N} = 그 게이트에서 그날 충분에 이르는 대응 수치 = ceil(Hazard Threat); {k} = 강인함 3, 기동·정신 4)
> {위험} — 대응 {N} 필요 · {능력치} 10마다 대응 {k} · {위험} 대응 상품이 막는다

예: `독 — 대응 13 필요 · 강인함 10마다 대응 3 · 독 대응 상품이 막는다` / `속박 — 대응 21 필요 · 기동 10마다 대응 4 · 속박 대응 상품이 막는다`

**현재 — 짧은 행** (아침 게이트 판 · SALE 목적지 판 · D25 · FINAL; User 2026-09-24 revision 2, v2.9.0. D25 · FINAL의 {N}은 마왕성 DAY 30 · T2 기준 29)
> {위험} · 대응 {N} 필요 · {능력치} 10마다 대응 {k}
...
**현재 — 구급키트** (User 2026-09-24, v2.9.0)
