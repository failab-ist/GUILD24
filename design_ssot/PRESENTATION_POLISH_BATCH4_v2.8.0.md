...
Batch 4 covers the Boss information reports only:
...
D0 is regression-only in this Batch.
...
- PRESENTATION_POLISH_v2.8.0.md — BOSS / MILESTONE FUNCTIONAL HIERARCHY and BOSS / FINAL
  PRESENTATION PAYOFF
- BOSS_v2.8.0.md — information cadence only
...
### BATCH 4B — COMPACT BEATS
- D10
- D20

Only start after 4A review.

D0 remains regression-only.
...
## BATCH 4B — D10 / D20 COMPACT REPORTS

D10 and D20 are intentionally compact.

They must feel like meaningful new investigation beats without pretending to reveal a major new
Boss fact.

Keep:
- Boss name / identity context
- compact 64px identity portrait
- one short owned investigation line
- next-report line
- one acknowledgement

Do not:
- use major-beat full art scale;
...
Exact portrait baseline:
- 64px phone and current responsive implementation unless Canonical is explicitly amended.

The compact beat should feel deliberately concise, not unfinished.
