...
Current Project Sources contain 23 authoritative MD files (mixed v2.5.0 and v2.6.0):

- `SPEC_INDEX_v2.6.0.md`
- `00_GAME_CORE_v2.5.0.md`
- `CORE_RUN_v2.5.0.md`
- `META_v2.6.0.md`
- `ECONOMY_ORDER_v2.6.0.md`
- `NPC_TRAIT_v2.6.0.md`
- `DUNGEON_HAZARD_v2.6.0.md`
- `ITEM_v2.5.0.md`
- `RELIC_v2.5.0.md`
- `SALE_v2.6.0.md`
- `NIGHT_CLOSING_v2.6.0.md`
- `UI_UX_v2.6.0.md`
...
## META
JOB MASTERY / JOB×BOSS CLEAR MATRIX -> META_v2.6.0.md
DISTINCT BOSS CLEAR / UNLOCK -> META_v2.6.0.md
FRANCHISE GRADE / MONSTER KNOWLEDGE -> META_v2.6.0.md
START CONTRACT UNLOCK / FRANCHISE GRADE GATE -> META_v2.6.0.md
JOB BASE/GROWTH MASTERY EFFECT CHANNEL -> NPC_TRAIT_v2.6.0.md
...
## ECONOMY / ORDER
PRICE/GOLD/WALLET/MARGIN -> ECONOMY_ORDER_v2.6.0.md
ORDER/OFFER/FULL-OFFER REROLL -> ECONOMY_ORDER_v2.6.0.md
NEXT-DAY TIER FORECAST -> ECONOMY_ORDER_v2.6.0.md
CUMULATIVE GROSS SALES -> ECONOMY_ORDER_v2.6.0.md

## NPC / TRAIT
JOB/GROWTH -> NPC_TRAIT_v2.6.0.md
TRAIT/LOYALTY/WALLET/REVISIT -> NPC_TRAIT_v2.6.0.md
TRUSTED REGULAR STATE OWNERSHIP -> NPC_TRAIT_v2.6.0.md
ROSTER/LIVING NPC CAP/DESTINATION/PRE-REVEAL -> NPC_TRAIT_v2.6.0.md

## DUNGEON
FAMILY/TIER/HAZARD/SUPPLY BURDEN -> DUNGEON_HAZARD_v2.6.0.md
COUNTER/FORECAST/COMBAT VARIANCE -> DUNGEON_HAZARD_v2.6.0.md
...
황금 1+1 쿠폰 UNLOCK -> META_v2.6.0.md
...
## SALE
CUSTOMER FLOW/ITEM/PRICE/REFUSAL -> SALE_v2.6.0.md
CONSUMER SLOT/DESTINATION REVEAL -> SALE_v2.6.0.md
COMMITTED SALE REVENUE -> SALE_v2.6.0.md

## NIGHT / CLOSING
NORMAL EXPEDITION RESULT/CAUSALITY -> NIGHT_CLOSING_v2.6.0.md
INJURY/DEATH/GROWTH RESULT -> NIGHT_CLOSING_v2.6.0.md
ECONOMIC SETTLEMENT -> NIGHT_CLOSING_v2.6.0.md

## UI / UX
PHASE UI/MOBILE -> UI_UX_v2.6.0.md
TUTORIAL/COACH MARK -> UI_UX_v2.6.0.md
EVENT REVEAL/FORECAST UI -> UI_UX_v2.6.0.md
BOSS/RELIC REVEAL ORDER UI -> UI_UX_v2.6.0.md
BOSS FINAL MODIFIER PREVIEW / BOSS ART -> UI_UX_v2.6.0.md
META PROGRESSION UI -> UI_UX_v2.6.0.md
...
META -> META_v2.6.0.md (embedded Meta QA)
...
run/phase/save                           -> CORE_RUN_v2.5.0.md
meta/mastery/unlock/grade/knowledge      -> META_v2.6.0.md
boss/sin/trait/reveal/sloth-seal         -> BOSS_v2.5.0.md
price/gold/wallet/order/offer/reroll     -> ECONOMY_ORDER_v2.6.0.md
npc/job/trait/roster/cap/revisit         -> NPC_TRAIT_v2.6.0.md
dungeon/family/hazard/supply/forecast    -> DUNGEON_HAZARD_v2.6.0.md
item/catalog/category/counter/supply     -> ITEM_v2.5.0.md
relic/build/facility/store-support       -> RELIC_v2.5.0.md
sale/customer/price/refusal              -> SALE_v2.6.0.md
night/injury/death/closing/settlement    -> NIGHT_CLOSING_v2.6.0.md
ui/ux/tutorial/mobile/event-reveal       -> UI_UX_v2.6.0.md
...
NPC WALLET GLOBAL BASELINE -> ECONOMY_ORDER_v2.6.0.md
D29 CLOSING / D30 PREP START GOLD TARGET -> ECONOMY_ORDER_v2.6.0.md
NORMAL GREAT-SUCCESS STORE GOLD BONUS -> ECONOMY_ORDER_v2.6.0.md

GREAT SUCCESS ELIGIBILITY / MARGIN / PROBABILITY -> DUNGEON_HAZARD_v2.6.0.md
DEEP EXPEDITION SCHEDULE / GATE VARIANT / POWER -> DUNGEON_HAZARD_v2.6.0.md

DEEP EXPEDITION NPC NOMINATION / SALE TIMING / DESTINATION -> SALE_v2.6.0.md
DEEP EXPEDITION DAY NORMAL-EVENT EXCLUSION -> EVENT_v2.5.0.md
DEEP EXPEDITION NPC EXP/GROWTH + WALLET REWARD -> NPC_TRAIT_v2.6.0.md

GREAT SUCCESS SIGNAL / TUTORIAL -> UI_UX_v2.6.0.md
FIRST-EVER DEEP EXPEDITION TUTORIAL -> UI_UX_v2.6.0.md

GREAT SUCCESS EXACT SIGNAL COPY / 심층원정 TERM / RUN ABANDON COPY
-> COPY_WORLD_VOICE_v2.5.0.md

GREAT SUCCESS / DEEP RESULT REPORTING -> NIGHT_CLOSING_v2.6.0.md

Search routing:
```text
run/abandon/forfeit/new-run-no-reward        -> CORE_RUN_v2.5.0.md
wallet/global-baseline/d30-prep-gold         -> ECONOMY_ORDER_v2.6.0.md
great-success/margin/over-preparation        -> DUNGEON_HAZARD_v2.6.0.md
deep-expedition/gate/power/schedule          -> DUNGEON_HAZARD_v2.6.0.md
deep-expedition/nomination/sale              -> SALE_v2.6.0.md
deep-expedition/event-exclusion              -> EVENT_v2.5.0.md
deep-expedition/npc-reward                   -> NPC_TRAIT_v2.6.0.md
great-success/tutorial/deep-tutorial         -> UI_UX_v2.6.0.md
