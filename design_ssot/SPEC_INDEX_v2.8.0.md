...
IMPLEMENTATION_BLOCKING_DESIGN_UNRESOLVED=Night lines for retreat healing and 만반의 준비 (copy drafts proposed); the NPC-detail row `무리한 출발 {n}회` no longer matches the v2.9.1 strain cut (UI_UX l.398) — awaiting User
