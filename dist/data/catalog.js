...
items:[
item('rice','삼각김밥',0,35,70,'fresh',2,'rice','용사픽','김 끝을 잡고 천천히.',{survival:3,food:5,supply:7}),
item('water','생수',0,25,55,'drink',5,'water','용사픽','뚜껑까지 챙겨 돌아오세요.',{survival:2,fatigue:-4,supply:4}),
item('ramen','컵라면',0,45,90,'food',4,'ramen','원정한끼','포만감과 냉기 저항. 먹고 나면 목이 마르다.',{survival:3,food:7,cold:8,thirst:4}),
item('bar','핫바',0,40,80,'fresh',2,'bar','용사픽','꼬치는 매장 앞 수거함에.',{combat:4,survival:5,food:4,supply:3}),
item('choco','초코바',0,30,65,'food',5,'choco','용사픽','빠른 에너지. 원정 후에는 조금 지친다.',{mobility:6,food:3,fatigue:2}),
item('coffee','캔커피',0,35,75,'drink',5,'coffee','MANA+','기동력 상승. 퇴근은 카페인으로 해결 안 된다.',{mobility:7,caffeine:1,fatigue:4}),
...
item('ice','얼음컵',0,25,60,'drink',4,'ice','용사픽','화염 저항 증가. 설원에서는 몸이 더 시리다.',{fire:17,cold:-7}),
item('battery','랜턴 건전지',0,40,85,'tool',0,'battery','귀환안심','어둠 속 시야를 확보한다.',{dark:17}),
item('lava','불룡볶음면',1,65,135,'food',4,'ramen','원정한끼','용 그림은 장식이 아니다.',{combat:8,cold:12,food:6,thirst:5},'cold5'),
item('energy','에너지드링크',1,70,150,'drink',5,'energy','MANA+','오늘 쓸 기운을 당겨왔다.',{mobility:13,caffeine:1,fatigue:7}),
item('wine','용사의 곡주',1,60,130,'drink',5,'wine','원정한끼','공포를 잊게 한다. 발걸음은 살짝 꼬인다.',{fear:24,mobility:-5,alcohol:1},'fear5'),
...
item('cloak','방수망토',1,75,160,'tool',0,'cloak','귀환안심','겉면이 상하면 교체하세요.',{corrosion:22}),
item('highpotion','상급 포션',2,150,300,'medicine',7,'potion','길드초이스','작은 병에 진하게 담았다.',{survival:27,potion:1}),
item('antidote','농축 해독제',2,220,450,'medicine',7,'antidote','귀환안심','독 저항을 높인다.',{poison:42,survival:5,curePoison:1},'poison10'),
item('stone','귀환석',2,260,520,'insurance',0,'stone','귀환안심','탈출 보정. 사망·중상 위기에서도 같은 수치의 추가 귀환 기회 1회.',{escape:0.55}),
item('mana','마석 보조배터리',2,240,500,'magic',0,'mana','MANA+','잡념까지 충전하지는 않는다.',{combat:4,spirit:25}),
item('premium','길드 프리미엄 도시락',2,280,560,'fresh',2,'lunch','길드초이스','뚜껑이 잘 안 닫힌다.',{survival:14,food:10,supply:10,loot:0.2}),
item('tree','세계수 생환부적',3,600,1200,'insurance',0,'stone','길드초이스','사망 판정을 한 번 중상으로 바꾼다.',{revive:1},'level15'),
item('dragon','용의 숨결 핫바',3,520,1050,'fresh',2,'bar','길드초이스','포장지부터 뜨겁다.',{combat:37,cold:10,food:5,injuryRisk:0.08},'fire12'),
...
{id:'slime',name:'슬라임 하수도',short:'슬라임 하수도',base:2,icon:'◉',color:'#8ac3a8',hazards:['corrosion','slow'],monster:'산성 슬라임',weakness:'강인함과 기동',reward:1},
...
hazards:{whiteout:'화이트아웃',supply:'보급 부담',poison:'독',bind:'속박',fire:'화염',armor:'높은 방어',fear:'공포',dark:'어둠',undead:'언데드',cold:'냉기',fatigue:'피로',long:'장기 원정',wet:'습지',corrosion:'부식',slow:'기동 감소'},
facilities:[],
events:[
...
G.DATA.balance={operating:60,frugalThreshold:120,tastingSupport:50,showoffLie:.6,bossPower:230,combatNoise:.135,rerollBase:30};
