...
const visit={
 ...
 helped:['“지난번에 챙긴 거, 도움이 됐어요.”','“저번 거 쓰고 나서 생각이 좀 바뀌었어요.”','“그때 산 거, 값은 했습니다.”',
  ...
  '“사장님 말대로 준비하길 잘했어요.”','“그거 없었으면 더 고생했을 거예요.”'],
...
const sale={
 ...
 overcharge:['“가격이 좀 올랐네요.”','“…뭐, 급하니까요.”','“이번만입니다.”','“원래 이 값이었나요?”',
  '“급한 대로 사야겠네요.”','“값을 따질 여유가 없네요.”','“오늘은 어쩔 수 없죠.”','“이 값에 팔릴 줄은 몰랐는데.”',
 ...
 refuse:{
  price:['“그 가격에는 못 사겠어요.”','“그건 좀 부담스럽네요.”','“다음에 여유 있을 때 살게요.”','“조금만 더 싸면 좋을 텐데.”',
   '“지금 가진 돈으로는 무리예요.”','“이 값은 좀 세네요.”','“다음 기회에 살게요.”','“오늘은 지갑 사정이 안 좋아서요.”',
   '“값을 보니 손이 안 가네요.”','“나중에 여유 생기면 볼게요.”','“이 가격엔 손이 떨려서요.”','“조금 더 모아서 올게요.”'],
...
const night={
 deathTraded:['마지막 영수증만 카운터에 남았다.','여기서 산 것들은 끝내 다 쓰이지 못했다.','거래는 이미 다 끝나 있었다.',
  '마지막으로 사 간 것들이 그대로 남았다.','계산대에 섰던 마지막 모습이 눈에 선하다.','그날의 거래가 마지막 거래가 됐다.'],
 ...
 plain:['“오늘도 무사히요.”','“내일도 열죠?”','“별일 없었습니다.”','“다녀왔습니다.”','“오늘은 별일 없었어요.”','“챙겨 간 건 잘 썼습니다.”',
  '“예상하지 못한 일이 있었어요. 잠깐 쉬어야겠어요.”','“오늘은 운이 안 따랐네요.”','“가는 길이 생각보다 사나웠어요.”',
