...
const visit={
 ...
 regular:['“늘 보던 얼굴이네요.”','“말 안 해도 아시죠?”','“자리 그대로네요, 다행이다.”','“오늘도 부탁 좀 할게요.”'],
 /* §12 Callback — 실제로 남아 있는 History만 쓴다. 없는 과거를 만들지 않는다. */
 helped:['“지난번에 챙긴 거, 도움이 됐어요.”','“그때 그거 아니었으면 못 돌아왔어요.”','“덕분에 한 번 살았습니다.”'],
 ...
 trait:{
  ...
  collector:['“이거 저번엔 없던 거죠?”','“새로 들어온 거 있어요?”','“못 보던 게 있네요.”'],
...
const sale={
 ...
 refuse:{
  ...
  need:['“그건 오늘 필요 없어요.”','“오늘 가는 데선 쓸 일이 없어서요.”','“이미 비슷한 게 있어요.”','“그건 다음에 볼게요.”'],
...
const night={
 deathTraded:['마지막 영수증만 카운터에 남았다.','예약해 둔 물건은 그대로 남았다.','계산은 어제 다 끝나 있었다.'],
 ...
 rescued:['“챙겨 간 보급이 귀환을 도왔어요.”','“가방에 있던 게 마지막에 일했어요.”','“하나 남은 걸로 버텼습니다.”'],
 severe:['“며칠만 쉬고 올게요. 제 자리 남겨 둬요.”','“당분간은 못 나갈 것 같아요.”','“다음에 올 때는 멀쩡한 얼굴로 올게요.”'],
 hurt:['“좀 다쳤지만, 살아 돌아왔어요.”','“이 정도는 다친 축에도 안 들어요.”','“내일은 좀 쉬엄쉬엄 갈게요.”','“약 하나만 더 챙길 걸 그랬어요.”'],
 ...
 plain:['“다녀왔습니다. 늘 먹던 걸로 주세요.”','“오늘도 무사히요.”','“내일도 열죠?”','“별일 없었습니다.”']};
