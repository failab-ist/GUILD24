...
G.DATA.decorations=[
 {id:'dawnSign', kind:'economy', slot:'sign',    name:'새벽배송 안내판',  price:1450, effect:'발주 후보 +1',
  text:'새벽마다 본사 물류가 한 줄 더 붙는다.'},
 {id:'guildPlaque', kind:'economy', slot:'wall', name:'길드 제휴 현판',   price:1250, effect:'매일 아침 10% 확률로 방문객 +1명',
  text:'길드 도장이 찍힌 현판. 가끔 이걸 보고 한 명이 더 들른다.'},
 {id:'thriftSafe', kind:'economy', slot:'counter',name:'알뜰 금고',      price:1150, effect:'영업 시작 자금 +300G',
  text:'카운터 아래 작은 금고. 개점 자금에 여유가 생긴다.'},
 {id:'premiumCase', kind:'economy',slot:'display',name:'프리미엄 쇼케이스',price:800, effect:'희귀한 모험가가 더 자주 찾아온다',
  text:'유리 너머로 좋은 물건이 보이면, 좋은 손님이 온다.'},
 /* Survival / combat alternatives, one per Slot (User decision 2026-09-24). A Slot still wears
    ONE Decoration, so each Slot is now a choice between running the store and keeping people
    alive. Same price as the economy Decoration of the same Slot. */
 {id:'memorialBoard', kind:'survival', slot:'sign',   name:'길드 추모 게시판', price:1450, effect:'영업이 끝나는 사망 기준 +1명',
  text:'돌아오지 못한 이름을 적어 둔다. 사람들은 이 점포가 잊지 않는다는 걸 안다.'},
 {id:'infirmaryPlaque', kind:'survival', slot:'wall', name:'의무실 현판',     price:1250, effect:'부상 모험가가 들르면 35% 확률로 회복',
  text:'길드 의무관이 들르는 날이 적혀 있다. 운이 좋으면 가게에서 붕대를 푼다.'},
 {id:'firstAidKit', kind:'survival', slot:'counter',  name:'비상 구급함',     price:1150, effect:'영업마다 첫 사망 1회를 중상으로',
  text:'카운터 밑 붉은 상자. 한 번은 누군가를 데려온다.'},
 {id:'trainingRack', kind:'survival', slot:'display', name:'훈련용 무기 진열대', price:800, effect:'처음 찾아오는 모험가 레벨 +1',
  text:'연습용 무기를 걸어 두면, 조금 더 단련된 사람이 문을 연다.'}];
/* The numbers the four alternatives read. Presentation copy above states the same values. */
G.DATA.decorationParams={memorialBoard:{deathLimitBonus:1},infirmaryPlaque:{healChance:.35},trainingRack:{levelBonus:1}};
