...
['kitchen','즉석식품 코너','foundation',['fresh'],280,'음식·음료가 원래 가진 능력치 효과 +40%. 보급·위험 대응·부작용은 그대로.'],
['board','길드 전광판','foundation',['customer'],260,'다음 날부터 방문객이 최소 4명. 한산한 날의 바닥을 올린다. 활동 가능한 인원 내에서 방문.'],
...
['expeditionMeal','원정 도시락 코너','hybrid',['fresh','expedition'],400,'음식·음료가 원래 가진 위험 대응 효과가 실제 목적지와 맞으면 해당 효과 +25%. 보급 부담이 있는 날 보급을 주는 음식·음료는 능력치 효과 +25%.'],
...
['fresh24','24시간 신선체계','keystone',['fresh'],740,'음식·음료 유통기한 +2일, 원래 가진 능력치 효과 +80%. 보급은 그대로.'],
['hub','지역 거점점 계약','keystone',['customer'],700,'다음 날부터 30% 확률로 방문객 +1명, 5% 확률로 +2명. 운영비 10% 증가. 활동 가능한 인원 내에서 방문.'],
