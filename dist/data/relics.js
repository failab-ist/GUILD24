...
['guarantee','길드 보증 진열대','foundation',['premium'],200,'하루 1회 · '+GUARANTEE_MIN_PRICE+'G 이상에 판 첫 상품은 판매가의 20%를 본사가 손님 대신 부담. 점주는 판매가 전액 수령.'],
...
['memberBundle','단골 묶음혜택','hybrid',['rotation','vip'],270,'단골 손님의 오늘 두 번째 유료 구매는 손님이 판매가의 절반만 낸다. 점주는 판매가 전액 수령.'],
['premiumMember','프리미엄 멤버십','hybrid',['vip','premium'],290,'단골 손님이 방문하면 소지금 +25G · 희귀 이상 상품 구매 의사 +15%p.'],
...
['coldcase','냉장 유통 계약','hybrid',['fresh','premium'],250,'고급 이상 음식·음료 발주 가중치 +80% · 구매 의사 +16%p · 유통기한 +1일 · 처음 확보할 때 보유 중인 해당 재고도 1회 연장.'],
['supplyCert','길드 납품 인증','hybrid',['premium','expedition'],310,'오늘 게이트의 위험에 대응하는 희귀 이상 상품, 또는 희귀 이상 보험을 팔면 정가의 20% 본사 수당 · 그 손님 소지금 +30G.'],
['dawnBulk','새벽 공동배송','hybrid',['fresh','rotation'],270,'같은 음식·음료 3개 이상 발주 시 매입가 -15%.'],
['logisticsHQ','물류 본부계약','keystone',['rotation'],430,'전날 6건 이상 판매했다면 오늘 같은 상품 3개 이상 발주 시 매입가 -30%.'],
['lifetime','평생 단골제','keystone',['vip'],440,'단골 손님이 생환하면 하루 1회 소지금 +50G · 다음 방문 가중치 +50%.'],
['royalCert','왕도 프리미엄 인증','keystone',['premium'],460,'상품을 150% 가격에 팔면 판매가의 20%를 본사 수당으로 받는다 · 150% 가격에 대한 손님의 구매 의사 감소(-16%p)가 없어진다.'],
