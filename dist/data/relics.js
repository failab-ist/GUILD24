...
['rookieBoard','첫 방문 쿠폰','foundation',['customer'],150,'처음 방문한 손님은 소지금 +30G · 구매 의사 +20%p.'],
['groupFlyer','단체 주문 창구','hybrid',['rotation','customer'],280,'매일 아침 20% 확률로 방문객 +1명 · 하루 5번째 판매부터 판매마다 본사 수당 +15G.'],
...
['dawnBulk','새벽 회수 계약','hybrid',['fresh','rotation'],270,'유통기한이 끝난 음식·음료는 폐기 대신 매입가의 50%로 회수 · 매일 첫 발주 후보에 음식 또는 음료 1칸 추가.'],
...
['expeditionCert','원정 전문 인증','keystone',['expedition'],420,'위험 대응 상품의 위험 대응 수치 +60% · 그 상품을 산 손님이 다음에 방문하면 소지금 +50G.'],
