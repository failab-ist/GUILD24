...
['rotation','회전 진열대','foundation',['rotation'],80,'전날 4건 이상 판매 시 다음 날 모든 상품 공급 수량 +1.'],
...
['showcase','희귀상품 입고 계약','foundation',['premium'],140,'희귀 이상 상품 발주 가중치 +70% · 희귀 이상 상품 판매가 +10% · 인상분은 손님 부담.'],
['guarantee','길드 보증 진열대','foundation',['premium'],140,'하루 1회 · '+GUARANTEE_MIN_PRICE+'G 이상에 판 첫 상품 판매가의 30%를 본사가 손님 대신 부담 · 점주는 판매가 전액 수령.'],
['hazardBoard','원정 위험 게시판','foundation',['expedition'],60,'오늘 게이트의 위험에 대응하는 상품의 발주 후보 가중치 +50%.'],
['medicine','야전 정비대','foundation',['expedition'],80,'판매한 야외장비의 위험 대응 수치 +40%.'],
['fridge','대형 냉장고','foundation',['fresh'],60,'음식·음료 유통기한 +2일 · 확보 시 보유 중인 해당 재고도 1회 연장.'],
...
['returnPoints','귀환 적립제','hybrid',['vip','expedition'],240,'오늘 유료 구매한 재방문 손님 생환 시 단골도 +5 · 소지금 +25G.'],
...
['logisticsHQ','물류 본부계약','keystone',['rotation'],300,'전날 6건 이상 판매 시 오늘 같은 상품 3개 이상 발주 매입가 -25%.'],
['lifetime','평생 단골제','keystone',['vip'],310,'단골 손님 생환 시 하루 1회 소지금 +50G · 다음 방문 가중치 +50%.'],
['royalCert','왕도 프리미엄 인증','keystone',['premium'],320,'150% 가격 판매 시 판매가의 40% 추가 지급 · 150% 가격 구매 의사 +16%p.'],
...
D.relicParams={
 ...
 showcase:{rareWeightMult:1.7,saleMult:1.1},
