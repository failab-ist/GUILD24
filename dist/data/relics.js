...
['rookieBoard','첫 방문 쿠폰','foundation',['customer'],110,'처음 온 손님 · 소지금 +30G · 구매 의사 +20%p.'],
['groupFlyer','단체 주문 창구','hybrid',['rotation','customer'],200,'아침마다 20% 확률로 방문객 +1명 · 하루 5번째 판매부터 판매마다 +15G.'],
...
['dawnBulk','새벽 회수 계약','hybrid',['fresh','rotation'],190,'유통기한이 끝난 음식·음료 · 폐기 대신 매입가의 50% 회수 · 매일 첫 발주 후보에 음식이나 음료 1칸 추가.'],
['logisticsHQ','물류 본부계약','keystone',['rotation'],300,'전날 6건 이상 팔았을 때 · 같은 상품 3개 이상 발주 매입가 -25%.'],
['lifetime','평생 단골제','keystone',['vip'],310,'단골 손님 생환 시 · 소지금 +50G (하루 1회) · 다음 방문 가중치 +50%.'],
