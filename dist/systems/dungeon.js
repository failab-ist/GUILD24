...
/* DUNGEON_HAZARD v2.9.0 §Hazard Defense (User 2026-09-24, revision 3): one non-투력 Stat per Hazard and no Gate's
   Hazards on the same Stat, 3 / 4 / 2 - 강인함 ×0.30 for 독·냉기·부식, 기동 ×0.40 for 속박·진창·화염·어둠, 정신 ×0.40 for
   공포·화이트아웃.
   One owner: the readiness calculation below and the player-facing Gate sentence (`{능력치} 10마다 대응 {k}`) read it. */
const HAZARD_RULES={poison:['survival',.3],cold:['survival',.3],corrosion:['survival',.3],bind:['mobility',.4],mire:['mobility',.4],fire:['mobility',.4],fear:['spirit',.4],dark:['mobility',.4],whiteout:['spirit',.4]};
