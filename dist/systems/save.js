...
function bossOk(r,D){
 ...
 /* the D10 / D20 beats persist their own one-time markers; a save written before the cadence
    existed simply has not seen them yet. */
 for(const k of ['familySeen','combatSeen','routeSeen'])
  if(seen[k]!==undefined && typeof seen[k]!=='boolean')return false;
