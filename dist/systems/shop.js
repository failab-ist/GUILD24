...
this.run.phase='foundation';this.relicWindow(0);return this.run;
 ...
 loyal(n,amount){const was=G.Adventurer.isTrustedRegular(n);n.loyalty=clamp(n.loyalty+amount,0,100);if(!was&&G.Adventurer.isTrustedRegular(n)){this.run.stats.regulars++;G.Meta.bump(this.account,'regular3');}}
