...
const BGM_VOICE=.020,BGM_BASS=.026,SFX_VOICE=.035;
const sfx={button:[440],quantity:[330],order:[392,523],sale:[523,659],refusal:[220,196],gold:[659,784],spend:[784,659],overcharge:[523,784,988],half:[392,523],relic:[392,523,659,784],level:[523,659,784],discovery:[440,659,880],open:[330,392,523],close:[392,330,262],depart:[392,330],return:[330,392],great:[523,659,784],injury:[262,220],severe:[196,165],death:[147,131],boss:[165,196,147]};
...
function play(kind='button'){if(!enabled||!ctx)return;ctx.resume().catch(()=>{});(sfx[kind]||sfx.button).forEach((hz,i)=>tone(hz,ctx.currentTime+i*.07,.16,SFX_VOICE,'triangle',sfxBus));}
