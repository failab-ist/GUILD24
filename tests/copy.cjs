...
test('COPY_AUDIT §11: all 30 Store Support names / prices / descriptions are the approved text',()=>{
 const SUPPORTS=[
  ...
  ['rotation','회전 진열대',120,'전날 4건 이상 판매 시 다음 날 모든 상품 공급 수량 +2.'],
  ...
  ['guarantee','길드 보증 진열대',200,'하루 1회 · 200G 이상에 판 첫 상품 판매가의 20%를 본사가 손님 대신 부담 · 점주는 판매가 전액 수령.'],
  ['hazardBoard','원정 위험 게시판',120,'오늘 게이트의 위험에 대응하는 상품의 발주 후보 가중치 +50%.'],
  ['medicine','야전 정비대',150,'판매한 야외장비의 위험 대응 수치 +40%.'],
  ['fridge','대형 냉장고',120,'음식·음료 유통기한 +2일 · 확보 시 보유 중인 해당 재고도 1회 연장.'],
  ['kitchen','즉석식품 코너',240,'음식·음료가 원래 가진 능력치 증가 효과 +25% · 보급·위험 대응·부작용 제외 · 다음 날부터 기본 운영비 +10%.'],
  ['board','길드 전광판',150,'하루 기본 최소 방문객을 4명으로 변경 (기존 3명).'],
  ['rookieBoard','첫 방문 쿠폰',150,'처음 방문한 손님의 소지금 +30G 추가 · 구매 의사 +20%p.'],
  ['groupFlyer','단체 주문 창구',280,'매일 아침 20% 확률로 방문객 +1명 · 하루 5번째 판매부터 판매마다 +15G 추가 지급.'],
  ['memberBundle','단골 묶음혜택',270,'단골 손님마다 오늘 두 번째로 사는 상품은 손님이 판매가의 절반만 지불 · 나머지 절반은 본사가 채워 점주는 판매가 전액 수령.'],
  ['premiumMember','프리미엄 멤버십',290,'단골 손님 방문 시 소지금 +25G · 희귀 이상 상품 구매 의사 +15%p.'],
  ['returnPoints','귀환 적립제',340,'오늘 유료 구매한 재방문 손님 생환 시 단골도 +5 · 소지금 +30G.'],
  ['expeditionMeal','원정 도시락 코너',280,'음식·음료 1개당 보급 +2 · 갈 게이트의 모든 위험 대응 +4.'],
  ['coldcase','냉장 유통 계약',250,'고급 이상 음식·음료 발주 가중치 +80% · 구매 의사 +16%p · 유통기한 +1일 · 확보 시 보유 중인 해당 재고도 1회 연장.'],
  ['supplyCert','길드 납품 인증',310,'오늘 게이트의 위험에 대응하는 희귀 이상 상품 또는 희귀 이상 보험 판매 시 정가의 20% 추가 지급 · 그 손님 소지금 +30G.'],
  ['dawnBulk','새벽 회수 계약',270,'유통기한이 끝난 음식·음료는 폐기 대신 매입가의 50% 회수 · 매일 첫 발주 후보에 음식 또는 음료 1칸 추가.'],
  ['logisticsHQ','물류 본부계약',430,'전날 6건 이상 판매 시 오늘 같은 상품 3개 이상 발주 매입가 -30%.'],
  ['lifetime','평생 단골제',440,'단골 손님 생환 시 하루 1회 소지금 +50G · 다음 방문 가중치 +50%.'],
  ['royalCert','왕도 프리미엄 인증',460,'150% 가격 판매 시 판매가의 20% 추가 지급 · 150% 가격 구매 의사 +16%p.'],
  ['expeditionCert','원정 전문 인증',420,'위험 대응 상품의 위험 대응 수치 +60% · 그 상품을 산 손님 다음 방문 시 소지금 +50G.'],
  ['fresh24','24시간 신선체계',520,'음식·음료가 원래 가진 능력치 증가 효과 +50% · 보급·위험 대응·부작용 제외 · 음식·음료 매입가 +25%.'],
  ['hub','지역 거점점 계약',490,'다음 날부터 방문객 +1명 45% · +2명 15% · 증가 없음 40% · 기본 운영비 +10%.'],
  ['warehouse','후방 창고 증설',180,'창고 용량 +10칸.'],
  ['terminal','본사 추가발주권',190,'다음 발주 후보 생성부터 발주 후보 +2개.'],
  ['delivery','발주 교환권',170,'매일 첫 후보 전체 교환 무료 · 이후 50G → 100G → 200G… 순으로 증가.'],
  ['efficiency','운영 효율 매뉴얼',180,'다음 날부터 기본 운영비 -30G.']];
