...
/* v2.9.0: one pressed Stat per Hazard, 3 / 3 / 3 - 어둠 presses 기동, 화염 presses 정신 (DUNGEON_HAZARD §HAZARD PLAYER-FACING PRESSURE) */
const PRESSURE={poison:'강인함',bind:'기동',corrosion:'강인함',mire:'기동',fire:'정신',fear:'정신',dark:'기동',cold:'강인함',whiteout:'정신'};
